...
create table if not exists dienstrapport (
  datum text, dienst text, route text, medewerker text, doel text, gehaald text, gemist text, eerste_scan text, laatste_scan text, ingeleverd text, reden text, opmerking text, voorman text,
...
alter table dienstrapport add column if not exists ingeleverd text;
